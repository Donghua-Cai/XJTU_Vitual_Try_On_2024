...
# dist.init_process_group("gloo",init_method="file:///d:/tmp/some_file",rank=opt.local_rank, world_size=1
#     # 'nccl',
#     # init_method='env://'
# )
...
for epoch in range(start_epoch, opt.niter + opt.niter_decay + 1):
    ...
    if epoch > opt.niter:
        model.update_learning_rate_warp(optimizer_warp)
        model.update_learning_rate(optimizer_gen)
