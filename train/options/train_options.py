...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--PBAFN_warp_checkpoint', default='checkpoints_fs/PBAFN_e2e_fs/PBAFN_warp_epoch_101.pth',type=str, help='load the pretrained model from the specified location')
        self.parser.add_argument('--PBAFN_gen_checkpoint', default='checkpoints_fs/PBAFN_e2e_fs/PBAFN_gen_epoch_101.pth',type=str,  help='load the pretrained model from the specified location')
        # for discriminators        
