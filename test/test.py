    ...
    for epoch in range(1, 2):
        ...
        for i, data in enumerate(dataset, start=epoch_iter):
            ...
            if step % 1 == 0:
                ...
                utils.save_image(
                    p_tryon,
                    # os.path.join('./Unetp_our_t_results', data['p_name'][0]),
                    os.path.join('./our_t_results', data['p_name'][0]),
                    # os.path.join('./cloudtry_our_t_results', data['p_name'][0]),
                ...
                utils.save_image(
                   combine,
                   # os.path.join('./Unetp_im_gar_flow_wg', data['p_name'][0]),
                   os.path.join('./im_gar_flow_wg', data['p_name'][0]),
                   #  os.path.join('./cloudtry_im_gar_flow_wg', data['p_name'][0]),
